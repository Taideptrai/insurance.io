...
describe('SignIn', () => {
  ...
  it(`'Invalid e-mail format' is displayed when enter invalid email`, () => {
    ...
    signInPage.getEmailError().should('be.visible').should('contain', 'Invalid e-mail format')
  })
  ...
  it(`'Required fiedld' should be displayed when enter invalid Password`, () => {
    ...
    signInPage.getPasswordError().should('be.visible').should('contain', 'Required field')
  })
